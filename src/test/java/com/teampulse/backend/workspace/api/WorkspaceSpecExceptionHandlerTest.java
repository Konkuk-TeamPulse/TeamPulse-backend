...
class WorkspaceSpecExceptionHandlerTest {

    private final WorkspaceSpecExceptionHandler handler = new WorkspaceSpecExceptionHandler();
    ...
    void validationResponseContainsFieldErrorsAndMeetingSpecificMessage() throws Exception {
        ...
        assertThat(response.getBody().result().errors())
                .extracting(WorkspaceSpecExceptionHandler.FieldErrorResponse::fieldName)
    ...
    private MethodArgumentNotValidException validationException(FieldError... errors) throws Exception {
        ...
        Method method = WorkspaceSpecExceptionHandlerTest.class.getDeclaredMethod("validate", ValidationTarget.class);
