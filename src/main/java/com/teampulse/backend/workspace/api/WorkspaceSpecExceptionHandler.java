...
import com.teampulse.backend.workspace.application.TooManyInvitationAttemptsException;
...
public class WorkspaceSpecExceptionHandler {
    ...
    @ExceptionHandler(TooManyInvitationAttemptsException.class)
    public ResponseEntity<SpecResponse<Void>> handleTooManyInvitationAttempts(TooManyInvitationAttemptsException exception) {
        return ResponseEntity.status(HttpStatus.TOO_MANY_REQUESTS)
                .body(SpecResponse.fail(3010, "\uCD08\uB300 \uCF54\uB4DC \uD655\uC778 \uC2E4\uD328\uAC00 \uBC18\uBCF5\uB418\uC5B4 \uC7A0\uC2DC \uD6C4 \uB2E4\uC2DC \uC2DC\uB3C4\uD574\uC8FC\uC138\uC694.", null));
    }
